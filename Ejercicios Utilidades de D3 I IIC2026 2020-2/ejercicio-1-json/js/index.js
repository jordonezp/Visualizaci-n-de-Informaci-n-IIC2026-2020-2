...
//    Usaremos axisBottom de d3, la que crea un eje horizontal con ticks abajo
    ...
    svg
          .append("g")
          .attr("transform", 
                    // Completar (posicionar el elemento abajo)
           )
          .call(
              // Llamar al eje x (xAxis)
          );
...
//    ticks hacia la izquiera también. Para eso utilizamos la utilidad axisLeft
    ...
    svg
          .append("g")
          .attr("transform", 
                    // Completar(posicionar el elemento después de los margenes)
           )
          .call(
              // Llamar al eje y (yAxis)
          );
...
//    fill -> Igual que rect, determina el color
    ...
    container
        ...
        .data(data)
        .join("circle")
        .attr("fill", (d) => typeColor[d.type[0]])
        .attr("r",
